   ...
   <@uniqueIdDiv>
      ...
      <div class="dashlet my-tasks">
         ...
         <div class="toolbar flat-button">
            ...
            <span class="align-right yui-button-align">
               <span class="first-child">
                  <a href="${url.context}/page/my-tasks-zitomedia#filter=ap-full|active" class="theme-color-1">${msg("link.activeTasks")}</a>
               </span>
               <span>&#124;</span>
               <span class="first-child">
                  <a href="${url.context}/page/my-tasks-zitomedia#filter=ap-full|completed" class="theme-color-1">${msg("link.completedTasks")}</a>
               </span>
            </span>
            <div class="clear"></div>
         </div>
