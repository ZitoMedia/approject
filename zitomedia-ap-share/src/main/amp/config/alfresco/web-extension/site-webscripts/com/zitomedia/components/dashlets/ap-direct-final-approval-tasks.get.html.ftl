...
<@markup id="js">
   ...
   <@script type="text/javascript" src="${url.context}/res/components/dashlets/zitomedia-my-tasks.js" group="dashlets"/>
</@>
      ...
      <div class="dashlet my-tasks">
         ...
         <div class="toolbar flat-button">
            <div class="hidden">
               ...
               <span class="align-left yui-button yui-menu-button" id="${id}-sort">
                  <span class="first-child">
                     <button type="button" tabindex="0"></button>
                  </span>
               </span>
               <select id="${id}-sort-menu">
                   <#list sorts as sort>
         ...
         <div class="toolbar flat-button">
            ...
            <span class="align-right yui-button-align">
               <span class="first-child">
                  <a href="${url.context}/page/my-tasks-zitomedia#filter=ap-direct|active" class="theme-color-1">${msg("link.activeTasks")}</a>
               </span>
               <span>&#124;</span>
               <span class="first-child">
                  <a href="${url.context}/page/my-tasks-zitomedia#filter=ap-direct|completed" class="theme-color-1">${msg("link.completedTasks")}</a>
               </span>
            </span>
            <div class="clear"></div>
         </div>
