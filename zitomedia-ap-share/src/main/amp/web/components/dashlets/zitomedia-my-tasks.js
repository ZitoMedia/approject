...
/**
 * Dashboard ZitoMediaMyTasks component.
 *
 * @namespace Alfresco.dashlet
 * @class Alfresco.dashlet.ZitoMediaMyTasks
 */
(function () {
    /**
     * YUI Library aliases
    ...
    /**
     * Dashboard ZitoMediaMyTasks constructor.
     *
     * @param {String} htmlId The HTML id of the parent element
     * @return {Alfresco.dashlet.ZitoMediaMyTasks} The new component instance
     * @constructor
     */
    Alfresco.dashlet.ZitoMediaMyTasks = function ZitoMediaMyTasks_constructor(htmlId) {
        Alfresco.dashlet.ZitoMediaMyTasks.superclass.constructor.call(this, "Alfresco.dashlet.ZitoMediaMyTasks", htmlId, ["button", "container", "datasource", "datatable", "paginator", "history", "animation"]);
     ...
     */
    YAHOO.extend(Alfresco.dashlet.ZitoMediaMyTasks, Alfresco.component.Base);

    /**
     * Augment prototype with Common Workflow actions to reuse createFilterURLParameters
     */
    YAHOO.lang.augmentProto(Alfresco.dashlet.ZitoMediaMyTasks, Alfresco.action.WorkflowActions);

    /**
     * Augment prototype with main class implementation, ensuring overwrite is enabled
     */
    YAHOO.lang.augmentObject(Alfresco.dashlet.ZitoMediaMyTasks.prototype, {
        /**
         * Preferences
         */
        PREFERENCES_TASKS_DASHLET: "",
        PREFERENCES_TASKS_DASHLET_FILTER: "",
        PREFERENCES_TASKS_DASHLET_SORT: "",
        /**
        ...
        options: {
            ...
            /**
             * Sort look-up: type to display value and query value
             *
             * @property sorts
             * @type Object
             */
         ...
         * @method onReady
         */
        onReady: function ZitoMediaMyTasks_onReady() {
            // Create filter menu
            ...
            this.PREFERENCES_TASKS_DASHLET_SORT = this.PREFERENCES_TASKS_DASHLET + ".sort";
            ...
            var sort = Alfresco.util.findValueByDotNotation(prefs, this.PREFERENCES_TASKS_DASHLET_SORT, "dueDes");
            sort = this.options.sorts.hasOwnProperty(sort) ? sort : "dueDes";
            ...
            var webscript = YAHOO.lang.substitute("api/zitomedia-task-instances?authority={authority}&properties={properties}&exclude={exclude}",
                {
            ...
            this.widgets.alfrescoDataTable = new Alfresco.util.DataTable(
                {
                    dataSource: {
                        ...
                        filterResolver: this.bind(function () {
                            ...
                            var sort = this.widgets.sortMenuButton.value;
                            var sortParameters = this.options.sorts[sort];
                            return this.substituteParameters(filterParameters + "&" + sortParameters) || "";
                        })
                    },
                    dataTable: {
            ...
            dataTable.doBeforeLoadData = function ZitoMediaMyTasks_doBeforeLoadData(sRequest, oResponse, oPayload) {
         ...
         */
        onFilterSelected: function ZitoMediaMyTasks_onFilterSelected(p_sType, p_aArgs) {
         ...
         * @param p_aArgs {array} Event arguments
         */
        onSortSelected: function ZitoMediaMyTasks_onSortSelected(p_sType, p_aArgs) {
            var menuItem = p_aArgs[1];
            ...
            if (menuItem) {
                ...
                var parameters = this.substituteParameters(this.options.sorts[menuItem.value], {});
                this.widgets.alfrescoDataTable.loadDataTable(parameters);

                // Save preferences
                this.services.preferences.set(this.PREFERENCES_TASKS_DASHLET_SORT, menuItem.value);
            }
        },
         ...
         */
        renderCellIcons: function ZitoMediaMyTasks_onReady_renderCellIcons(elCell, oRecord, oColumn, oData) {
         ...
         */
        renderCellTaskInfo: function ZitoMediaMyTasks_onReady_renderCellTaskInfo(elCell, oRecord, oColumn, oData) {
            var data = oRecord.getData(),
                desc = "";
         ...
         */
        renderCellActions: function ZitoMediaMyTasks_onReady_renderCellActions(elCell, oRecord, oColumn, oData) {
            var data = oRecord.getData(),
                desc = "";
